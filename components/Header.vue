<template>
  <div
    class="w-full px-4 sm:px-4 h-[72px] flex justify-between items-center bg-bgLight border-b-[1px] border-[#22222215]"
  >
    <div class="flex justify-center items-center gap-x-1">
      ...
      <h2
        @mouseenter="handleMouseEnter"
        class="hidden lg:block text-lg font-medium text-primary cursor-pointer"
      >
        Uniswap
      </h2>
      <div
        @click="handleClick"
        @mouseenter="handleMouseEnter"
        class="flex justify-center items-center gap-x-[3px]"
      >
        <svg
          viewBox="0 0 18 12"
          fill="none"
      ...
      <div
        class="sm:flex justify-center items-center gap-x-6 hidden text-textSecondary font-medium text-lg ps-4 cursor-pointer"
      >
        <NuxtLink to="/swap" class="hover:text-textPrimary">Trade</NuxtLink>
        <p class="hover:text-textPrimary">Explore</p>
        <p class="hover:text-textPrimary">Pool</p>
      </div>
    </div>
    <div
      @click="menuStore.handleToggleOpenSearch"
      class="hidden lg:block relative w-[400px]"
    >
      ...
      <input
        ...
        class="w-full rounded-full bottom-[1px] border border-solid border-[rgba(34, 34, 34, 0.08)] bg-[#F9F9F9] text-textSecondary py-[8px] px-4 pl-12 outline-none"
      />
    </div>

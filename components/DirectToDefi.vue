<template>
  <div
    class="py-10 w-full px-6 sm:px-10 lg:px-16 flex flex-col gap-y-8 justify-start items-start"
  >
    <h1 class="text-textPrimary tracking-wide sm:text-4xl text-2xl font-medium">
      Go direct to DeFi
    </h1>
    <div class="w-full justify-center items-center flex gap-5 flex-wrap">
      ...
      >
        ...
        <h1 class="text-[#2ABDFF] tracking-wide text-xl font-medium">
          Swapping made simple. Acceess thousands of tokens on 11+ chains.
        </h1>
        <div
        ...
        >
          ...
          >
            <div class="flex gap-x-2 items-center justify-center">
              ...
              <h1 class="text-textPrimary font-medium text-lg">Ethereum</h1>
              <p class="text-lg text-textSecondary">ETH</p>
            </div>
      ...
      >
        ...
        <h1 class="tracking-wide text-2xl font-medium py-4">
      ...
      >
        ...
        <h1 class="tracking-wide text-2xl font-medium py-4">
          Provide liquidity to pools on the Uniswap Protocol and earn fees on
          swaps.
        </h1>
      </div>
    </div>
